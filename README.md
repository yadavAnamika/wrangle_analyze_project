Data Analyst nanodegree - Udacity (Wrangle and Analyze Data Project)
...
# Project Details
Entire assessing and cleaning of the dataset would have required an exceptional effort so only a subset of its issues (eight quality issues and two tidiness issues at minimum) were assessed and cleaned.

The process followed for this project was:
